...
public class MindlessWanderPattern : AbstractAIMovementPattern{
	...
	[SerializeField] private bool _moveFreeForm = false;

	[Tooltip("The speed at which this object wanders across the screen. Has no affect on the wander time, just movement speed.")]
	[SerializeField] private float _wanderSpeed = 5f;
	
	[Tooltip("The maximum amount of time this data will wander around in a given direction. Used to randomly decide when to change directions.")]
	[SerializeField] private float _wanderMaxInterval = 10f;
	
	[Tooltip("The minimum amount of time this data will wander around in a given direction. Used to randomly decide when to change directions.")]
	[SerializeField] private float _wanderMinInterval = 5f;
